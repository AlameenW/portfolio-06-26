...
export default function Home() {
  return (
    <>
      ...
      <main>
        ...
        <section className="hero" id="home">
          ...
          <h1 className="reveal-up">
            ...
            <span className="line"><span className="hl">Adeku</span></span>
          </h1>
          <p className="hero-role reveal" data-d="1">
            <b>Full&nbsp;Stack&nbsp;Developer</b> <span className="sep">/</span> <b>AI&nbsp;Engineer</b>
          </p>
          ...
          <div className="about-grid">
            ...
            <div className="about-body reveal" data-d="1">
              <p>
                ...
                <b>Southeastern Louisiana University</b>. I specialize in building websites with
                beautiful, modern, and user-friendly designs, taking products from first sketch to
              ...
              <p>I flourish in collaborative environments and am always excited to pick up new technologies to sharpen my craft.</p>
        ...
        <section id="skills">
          <div className="sec-head reveal">
            <div className="eyebrow"><b>02</b> / Skills</div>
            <h2 className="section-title">
          ...
          <div className="skills-grid">
            <div className="skill-card reveal" data-d="1">
              <div className="skill-head">
                <span className="skill-sq" style={{ background: "var(--yellow)" }}></span>
                <h3>Frontend</h3>
            ...
            <div className="skill-card reveal" data-d="2">
              <div className="skill-head">
                <span className="skill-sq" style={{ background: "var(--cobalt)" }}></span>
                <h3>Backend</h3>
            ...
            <div className="skill-card reveal" data-d="3">
              <div className="skill-head">
                <span className="skill-sq" style={{ background: "var(--bone)" }}></span>
                <h3>Data Science</h3>
                <span className="ct">05</span>
              </div>
              <div className="badges">
        ...
        <section id="contact">
          <div className="sec-head reveal">
            <div className="eyebrow"><b>04</b> / Contact</div>
          </div>
          <div className="contact-wrap">
            <div className="contact-left">
              ...
              <p className="section-sub reveal">
                Have a role, project, or idea in mind? My inbox is always open — I&apos;ll get back to
                you fast.
              </p>
              <div className="socials reveal" data-d="1">
                <a href="https://github.com/AlameenW" target="_blank" rel="noopener" className="social-link">
                  <span className="si">
                  ...
                  <span className="meta"><span className="t">GitHub</span><span className="h">@AlameenW</span></span>
                  <span className="ext">↗</span>
                </a>
                <a href="https://www.linkedin.com/in/alameen-adeku-2507492b6/" target="_blank" rel="noopener" className="social-link">
                  <span className="si">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="meta"><span className="t">LinkedIn</span><span className="h">in/alameen-adeku</span></span>
                  <span className="ext">↗</span>
                </a>
              </div>
            </div>
      ...
      <footer>
        <a href="#home" className="logo" aria-label="Home"><span className="a-mark">A</span></a>
